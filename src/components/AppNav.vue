...
defineProps<{ logo: string, listItems: any[] }>()
  ...
  <nav class="bg-white shadow">
      ...
      <div class="flex justify-center h-16">
        <div class="flex justify-between w-full">
          <div class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-8 w-auto" :src="logo" alt="Kisumu Residence Portal">
            <img class="hidden lg:block h-8 w-auto" :src="logo" alt="Kisumu Residence Portal">
          </div>
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            <div v-if="!loggedIn" class="hidden space-x-4 sm:flex sm:items-center">
              <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Sign In</button>
              <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-blue-600 bg-transparent border-2 border-blue-600 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Create Account</button>
            </div>
          </div>
        </div>
    ...
    <div class="sm:hidden" id="mobile-menu">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <a href="#" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">FAQs</a>
      </div>

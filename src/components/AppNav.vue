  ...
  <nav class="bg-white">
    ...
    <div v-show="mobileMenuOpen" class="md:hidden" id="mobile-menu">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <router-link to="/" class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Home</router-link>
      ...
      <div v-if="mainStore.getLoggedInState" class="pt-4 pb-3 border-t border-gray-200">
        ...
        <div class="mt-3 space-y-1">
          ...
          <a @click="logOutUser" href="#" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">Sign out</a>
        </div>
      </div>

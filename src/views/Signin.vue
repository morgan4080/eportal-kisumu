            ...
            <div class="relative block w-full rounded-lg bg-white shadow-2xl overflow-hidden">
              <div class="lg:absolute lg:inset-0">
                <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                  <img class="h-72 w-full object-cover lg:absolute lg:h-full" :src="currentTab === 1 ? '/src/assets/SignIn-IndividualAccount.png' : '/src/assets/SignIn-BusinessAccount.png'" alt="">
                </div>
              </div>
